...
export default function Contests() {
  const activeContests = [
    {
      id: 1,
      title: "Super Bowl LIX Mega Pool",
      category: "Sports",
      prizePool: "$25,000",
      entries: 1245,
      endsIn: "4d 12h",
      color: "#FF3CAC",
      description: "Submit your NFL prediction cards. Highest accuracy wins."
    },
    {
      id: 2,
      title: "Q3 Crypto Sentiment",
      category: "Crypto",
      prizePool: "50 SOL",
      entries: 890,
      endsIn: "12d 5h",
      color: "#00E5FF",
      description: "Hold or submit BTC/ETH prediction cards."
    },
    {
      id: 3,
      title: "Oscars 2025 Predictor",
      category: "Entertainment",
      prizePool: "$5,000",
      entries: 340,
      endsIn: "2mo 4d",
      color: "#7B2FBE",
      description: "Best Picture, Best Actor, Best Actress sweeps."
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Put your cards to work. Enter prediction cards into contests to win crypto prizes and exclusive drops.
            </p>
          </div>

          <div className="flex gap-4 mb-8 overflow-x-auto pb-2 scrollbar-hide">
            <Button className="bg-white text-black hover:bg-gray-200 rounded-full px-6">All Contests</Button>
            <Button variant="outline" className="rounded-full px-6">Sports</Button>
            <Button variant="outline" className="rounded-full px-6">Crypto</Button>
            <Button variant="outline" className="rounded-full px-6">Gaming</Button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {activeContests.map((contest) => (
              ...
              >
                <div 
                  className="absolute top-0 right-0 w-64 h-64 bg-white opacity-[0.03] blur-3xl rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none"
