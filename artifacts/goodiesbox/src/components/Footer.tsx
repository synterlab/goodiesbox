        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-16">
          ...
          <div className="md:col-span-4">
            ...
            <div className="mt-8 flex flex-col gap-4">
               <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-[#FF3CAC]/10 border border-[#FF3CAC]/20 text-[#FF3CAC] w-fit">
               ...
               {/* Orynth badge */}
               <a
                 href="https://orynth.dev/projects/goodies-box-3788"
                 target="_blank"
                 rel="noopener noreferrer"
                 className="w-fit opacity-90 hover:opacity-100 transition-opacity"
               >
                 <img
                   src="https://orynth.dev/api/badge/goodies-box-3788?theme=dark&style=default"
